...
/**
 * @file    STM32F4xx/dac_lld.h
 * @brief   STM32F4xx DAC subsystem low level driver header.
 *
 * @addtogroup DAC
 * @{
 */
...
#define STM32_DAC_CR_WAVE_NOISE     DAC_CR_WAVE2_0
#define STM32_DAC_CR_WAVE_TRIANGLE  DAC_CR_WAVE2_1
