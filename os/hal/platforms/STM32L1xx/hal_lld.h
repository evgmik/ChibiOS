...
#define STM32_DAC_CHN1_DMA_STREAM   STM32_DMA_STREAM_ID(1, 2)
#define STM32_DAC_CHN1_DMA_MSK      (STM32_DMA_STREAM_ID_MSK(1, 2))
#define STM32_DAC_CHN1_DMA_CHN      0x00000000

#define STM32_HAS_DAC_CHN2          TRUE
#define STM32_DAC_CHN2_DMA_STREAM   STM32_DMA_STREAM_ID(1, 3)
#define STM32_DAC_CHN2_DMA_MSK      (STM32_DMA_STREAM_ID_MSK(1, 3))
